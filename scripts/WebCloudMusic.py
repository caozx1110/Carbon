...
project: Audio
file: WebCloudMusic.py
date: 2021/8/8
function: pycryptodome, https://blog.csdn.net/qq_36779888/article/details/90738012
"""
...
class WebCloudMusic:
    ...
    # 获取指定音乐列表(相当于主函数)
    @staticmethod
    def get_music_list(keywords):
        music_list = []
        for offset in range(1):
            result = WebCloudMusic().search(keywords, str(offset))
...
if __name__ == '__main__':
    SearchResult = WebCloudMusic().get_music_list("这首歌没唱")
